...
export const Hero = () => {
  ...
  return (
    <>
      <section className="flex relative overflow-hidden lg:overflow-visible w-full flex-nowrap translate-y-[-10%] justify-between items-center h-[calc(60vh_-_64px)] 2xl:h-[calc(64vh_-_44px)]">
