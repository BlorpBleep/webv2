---
title: Install Guide for Windows
description: Step-by-step instructions for installing and setting up CicadaVPN on Windows devices.
---

# CicadaVPN Windows Installation Guide
...
2. Scroll down to the **Windows** section and click the **Download for Windows** button.
3. The download for the CicadaVPN installer will begin automatically.
...
2. Once the installation is complete, launch the CicadaVPN app from your desktop or Start menu.
...
1. Once logged in and activated, the app will request permission to set up a VPN connection on your Windows device.
2. Click **Allow** when prompted. This is required for CicadaVPN to securely route your traffic through our servers.
...
That’s it! You’re now set up with CicadaVPN on your Windows device. Enjoy safe, private browsing and access to content worldwide.
