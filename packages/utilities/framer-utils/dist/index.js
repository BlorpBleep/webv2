...
var ResizablePanel = (0, import_react.forwardRef)(
  (originalProps, ref) => {
    ...
    return <import_framer_motion.LazyMotion features={import_framer_motion.domAnimation}><import_framer_motion.m.div
      ref={ref}
      animate={{
    ...
    ><div ref={measureRef} {...props}>{children}</div></import_framer_motion.m.div></import_framer_motion.LazyMotion>;
  }
);
